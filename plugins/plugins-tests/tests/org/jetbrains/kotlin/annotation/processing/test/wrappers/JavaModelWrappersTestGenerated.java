...
public class JavaModelWrappersTestGenerated extends AbstractJavaModelWrappersTest {
    ...
    @TestMetadata("RepeatableAnnotations")
    public void testRepeatableAnnotations() throws Exception {
        String fileName = KotlinTestUtils.navigationMetadata("plugins/annotation-processing/testData/javaWrappers/RepeatableAnnotations/");
        doTest(fileName);
    }
