...
abstract class AbstractAnnotationProcessingExtension(
    ...
    override fun analysisCompleted(
        ...
        log { "Initialized processors: " + processors.joinToString { it.javaClass.canonicalName } }
        ...
        for (processor in processors) {
            ...
            if (applicableAnnotationNames.isEmpty()) {
                log { "Skipping processor " + processor.javaClass.canonicalName + ": no relevant annotations" }
                continue
            }
            ...
            log {
                ...
                "Processing with " + processor.javaClass.canonicalName + " (annotations: " + annotationNames + ")"
            }
        ...
        log { "Annotation processing complete. Has errors = ${messager.hasErrors}, has warnings = ${messager.hasWarnings}" }
