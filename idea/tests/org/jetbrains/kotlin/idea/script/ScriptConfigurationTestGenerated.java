...
public class ScriptConfigurationTestGenerated extends AbstractScriptConfigurationTest {
    ...
    public void testAllFilesPresentInHighlighting() throws Exception {
        KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/script/definition/highlighting"), Pattern.compile("^([^\\.]+)$"), true);
    }
